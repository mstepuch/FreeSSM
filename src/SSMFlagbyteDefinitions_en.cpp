...
const QStringList SSMFlagbyteDefinitions_en::_MB_defs_en =
	...
	<< "1;2;1;00000D;;Air – Manifold Absolute Pressure (MAP);kPa;*1;0"
	<< "1;3;1;00000C;;Fuel Trim – LTFT B2;%;-128/128*100;1"
	<< "1;4;1;00000B;;Fuel Trim – STFT B2;%;-128/128*100;1"
	<< "1;5;1;00000A;;Fuel Trim – LTFT B1;%;-128/128*100;1"
	<< "1;6;1;000009;;Fuel Trim – STFT B1;%;-128/128*100;1"
	<< "1;7;1;000008;;Engine – Coolant Temperature (ECT);°C;-40;0"
	<< "1;8;1;000007;;Engine – Load;%;/255*100;1"
	<< "2;1;1;00001B;00001A;O2 – Pre-Cat B2 Voltage;V;/200;3"
	<< "2;2;1;000019;000018;O2 – Post-Cat Voltage;V;/200;3"
	<< "2;3;1;000017;000016;O2 – Pre-Cat B1 Voltage;V;/200;3"
	<< "2;4;1;000015;;Air – Throttle Position (TPS);%;/255*100;1"
	<< "2;5;1;000014;000013;Air – Mass Flow (MAF);g/s;/100;2"
	<< "2;6;1;000012;;Air – Intake Temperature (IAT);°C;-40;0"
	<< "2;7;1;000011;;Ignition – Timing;deg;-128/2;1"
	<< "2;8;1;000010;;Engine – Vehicle Speed;km/h;*1;0"
	<< "3;1;1;000023;;Air – Atmospheric Pressure;kPa;*1;0"
	<< "3;2;1;000022;;Ignition – Knock Correction;deg;-128/2;1"
	<< "3;3;1;000021;;Fuel – Injection Pulse B2;ms;*256/1000;2"
	<< "3;4;1;000020;;Fuel – Injection Pulse B1;ms;*256/1000;2"
	<< "3;5;1;00001F;;Air – Differential Pressure Sensor Voltage;V;/50;2"
	<< "3;6;3;00001E;;Air – Throttle Sensor Voltage;V;/50;2"
	<< "3;7;3;00001D;;Air – MAF Sensor Voltage;V;/50;2"
	<< "3;8;3;00001C;;Electrical – Battery Voltage;V;*2/25;1"
	<< "4;1;1;00002B;;O2 – Pre-Cat B1 Heater Current;A;/255*10;2"
	<< "4;2;1;00002A;;Fuel – Temperature;°C;-40;0"
	<< "4;3;3;000029;;Air – Pedal Position;%;/255*100;1"
	<< "4;4;1;000028;;Ignition – Learned Timing;deg;-128/2;1"
	<< "4;5;1;000027;;Fuel Trim – CO Pot Voltage;V;/50;2"
	<< "4;6;1;000026;;Fuel – Tank Pressure (EVAP);kPa;-128/40;2"
	<< "4;7;1;000025;;Air – Differential Pressure Sensor;kPa;-128;0"
	<< "4;8;1;000024;;Air – Manifold Relative Pressure;kPa;-128;0"
	<< "5;1;1;000033;;Turbo – TGV Position Right;V;/50;2"
	<< "5;2;1;000032;;Fuel – CPC Valve Duty;%;/255*100;0"
	<< "5;3;1;000031;;Turbo – Secondary Wastegate Duty;%;/255*100;1"
	<< "5;4;1;000030;;Turbo – Primary Wastegate Duty;%;/255*100;1"
	<< "5;5;1;00002F;;Cooling – Radiator Fan Duty;%;*1;0"
	<< "5;6;1;00002E;;Fuel – Level Sensor Voltage;V;/50;2"
	<< "5;7;1;00002D;;O2 – Pre-Cat B2 Heater Current;A;/255*10;2"
	<< "5;8;1;00002C;;O2 – Post-Cat Heater Current;A;/255*10;2"
	<< "6;1;1;00003B;;Fuel – Pump Duty;%;/255*100;0"
	<< "6;2;1;00003A;;Electrical – Alternator Duty;%;*1;0"
	<< "6;3;1;000039;;EGR – Steps;steps;*1;0"
	<< "6;4;1;000038;;Idle – ISC Valve Steps;steps;*1;0"
	<< "6;5;1;000037;;Fuel Trim – Heater Duty;%;/255*100;1"
	<< "6;6;1;000036;;Fuel Trim – Lean Correction;%;/255*100;0"
	<< "6;7;1;000035;;Idle – ISC Valve Duty;%;/2;1"
	<< "6;8;1;000034;;Turbo – TGV Position Left;V;/50;2"
	<< "7;1;1;000043;;O2 – Pre-Cat B2 Current;mA;-128/8;2"
	<< "7;2;1;000042;;O2 – Pre-Cat B1 Current;mA;-128/8;2"
	<< "7;3;1;000041;;VVT – OCV Current Left Intake;mA;*32;0"
	<< "7;4;1;000040;;VVT – OCV Current Right Intake;mA;*32;0"
	<< "7;5;1;00003F;;VVT – OCV Duty Left Intake;%;/255*100;1"
	<< "7;6;1;00003E;;VVT – OCV Duty Right Intake;%;/255*100;1"
	<< "7;7;1;00003D;;VVT – Advance Angle Left Intake;deg;-50;0"
	<< "7;8;1;00003C;;VVT – Advance Angle Right Intake;deg;-50;0"
	<< "8;1;1;0000D3;;Fuel Trim – Adjust Voltage;V;/50;2"
	<< "8;2;1;0000D2;;O2 – Post-Cat Heater Voltage;V;/50;2"
	<< "8;3;1;0000D1;;Fuel Trim – LTFT B3;%;-128/128*100;2"
	<< "8;4;1;0000D0;;Fuel Trim – STFT B3;%;-64/128*10;2"
	<< "8;5;1;000047;;O2 – Pre-Cat B2 Lambda;;/128;2"
	<< "8;6;1;000046;;O2 – Pre-Cat B1 Lambda;;/128;2"
	<< "8;7;1;000045;;O2 – Pre-Cat B2 Resistance;ohms;*1;0"
	<< "8;8;1;000044;;O2 – Pre-Cat B1 Resistance;ohms;*1;0"
	<< "9;1;2;00004F;;AT – Turbine Speed;rpm;*32;0"
	<< "9;2;2;00004E;;AT – Throttle Sensor Voltage;V;/45;2"
	<< "9;3;2;00004D;;AT – Transfer Duty;%;/2;1"
	<< "9;4;2;00004C;;AT – Lock-Up Duty;%;/2;1"
	<< "9;5;2;00004B;;AT – Line Pressure Duty;%;/2;1"
	<< "9;6;3;00004A;;Engine – Gear Position;gear;+1;0"
	<< "9;7;2;000049;;AT – ATF Temperature (Lookup);°C;0=-60,1=-60,2=-51,3=-45,4=-40,5=-37,6=-34,7=-31,8=-29,9=-27,10=-25,11=-23,12=-22,13=-20,14=-19,15=-17,16=-16,17=-15,18=-14,19=-13,20=-12,21=-10,22=-9,23=-9,24=-8,25=-7,26=-6,27=-5,28=-4,29=-3,30=-2,31=-2,32=-1,33=0,34=1,35=1,36=2,37=3,38=3,39=4,40=5,41=5,42=6,43=7,44=7,45=8,46=8,47=9,48=10,49=10,50=11,51=11,52=12,53=12,54=13,55=13,56=14,57=15,58=15,59=16,60=16,61=17,62=17,63=18,64=18,65=19,66=19,67=20,68=20,69=21,70=21,71=22,72=22,73=23,74=23,75=23,76=24,77=24,78=25,79=25,80=26,81=26,82=27,83=27,84=28,85=28,86=29,87=29,88=29,89=30,90=30,91=31,92=31,93=32,94=32,95=33,96=33,97=33,98=34,99=34,100=35,101=35,102=36,103=36,104=37,105=37,106=37,107=38,108=38,109=39,110=39,111=40,112=40,113=41,114=41,115=41,116=42,117=42,118=43,119=43,120=44,121=44,122=45,123=45,124=45,125=46,126=46,127=47,128=47,129=48,130=48,131=49,132=49,133=50,134=50,135=50,136=51,137=51,138=52,139=52,140=53,141=53,142=54,143=54,144=55,145=55,146=56,147=56,148=57,149=57,150=58,151=58,152=59,153=59,154=60,155=60,156=61,157=61,158=62,159=62,160=63,161=63,162=64,163=65,164=65,165=66,166=66,167=67,168=67,169=68,170=68,171=69,172=70,173=70,174=71,175=71,176=72,177=73,178=73,179=74,180=75,181=75,182=76,183=77,184=77,185=78,186=79,187=79,188=80,189=81,190=81,191=82,192=83,193=84,194=84,195=85,196=86,197=87,198=88,199=88,200=89,201=90,202=91,203=92,204=93,205=94,206=95,207=96,208=97,209=98,210=99,211=100,212=101,213=102,214=103,215=104,216=105,217=107,218=108,219=109,220=110,221=112,222=113,223=115,224=116,225=118,226=119,227=121,228=123,229=125,230=127,231=129,232=131,233=133,234=135,235=138,236=140,237=143,238=146,239=149,240=152,241=156,242=159,243=164,244=168,245=173,246=179,247=186,248=193,249=202,250=212,251=225,252=241,253=264,254=300,255=373;0"
	<< "9;8;2;000048;;AWD – Wheel Speed Front;km/h;*1;0"
	<< "10;1;2;000057;;AT – Low Clutch Duty;%;/2;1"
	<< "10;2;2;000056;;AT – ATF Temperature;°C;-50;0"
	<< "10;3;2;000055;;AWD – Lateral G Sensor Voltage;V;/50;2"
	<< "10;4;1;000054;;O2 – Pre-Cat B2 Heater Current;A;/10;1"
	<< "10;5;1;000053;;O2 – Pre-Cat B1 Heater Current;A;/10;1"
	<< "10;6;2;000052;;Air – Manifold Pressure Sensor Voltage (AT);V;/50;2"
	<< "10;7;2;000051;;AWD – Wheel Speed Rear;km/h;*1;0"
	<< "10;8;2;000050;;AT – Brake Clutch Duty;%;/2;1"
	<< "11;1;2;00005F;;AT – Center Differential Requested Current;A;/32;2"
	<< "11;2;2;00005E;;AT – Center Differential Actual Current;A;/32;2"
	<< "11;3;2;00005D;;AT – Turbine Speed 2;rpm;*32;0"
	<< "11;4;2;00005C;;AT – Turbine Speed 1;rpm;*32;0"
	<< "11;5;2;00005B;;AT – Center Differential Switch Voltage;V;/51;2"
	<< "11;6;2;00005A;;AT – ATF Temperature 2;°C;-50;0"
	<< "11;7;2;000059;;AT – L&R Brake Duty;%;/2;1"
	<< "11;8;2;000058;;AT – High Clutch Duty;%;/2;1"
	<< "31;5;1;0000FB;;Air – Throttle Motor Voltage;V;*2/25;1"
	<< "31;6;1;0000FA;;Air – Throttle Motor Duty;%;-128/128*100;0"
	<< "31;7;1;00016B;;Air – Throttle Closed Voltage;V;/50;2"
	<< "31;8;3;00016A;;Engine – SI-Drive Mode;;0=---,1=S,2=S#,3=I,8=S#,16=I;"
	<< "33;1;1;000107;;Exhaust – Gas Temperature 2;°C;*5+200;0"
	<< "33;2;1;000106;;Exhaust – Gas Temperature 1;°C;*5+200;0"
	<< "33;3;1;000105;;Fuel – Pressure GDI;kPa;*2;0"
	//<< "33;4;1;1;000104;;Brake Booster Pressure;kPa;*1;0"			// UNCONFIRMED !!!
	<< "33;5;1;000103;;Air – Pedal Sensor Main Voltage;V;/50;2"
	<< "33;6;3;000102;;Air – Pedal Sensor Sub Voltage;V;/50;2"
	<< "33;7;1;000101;;Air – Throttle Sensor Main Voltage;V;/50;2"
	<< "33;8;1;000100;;Air – Throttle Sensor Sub Voltage;V;/50;2"
	<< "34;1;1;000173;000172;Fuel – Tank Air Pressure;MPa;/100;1"
	<< "34;2;1;00010F;00010E;Engine – Odometer;km;*2;0"
	<< "34;3;1;00010D;;Fuel – Level Sensor Resistance;ohms;*4/2;1"
	<< "34;4;1;00010C;;Fuel Trim – LTFT B4;%;-128/128*100;2"
	<< "34;5;1;00010B;;Fuel Trim – STFT B4;%;-64/128*10;2"
	<< "34;6;1;00010A;;Engine – Cruise Speed Memory;km/h;*1;0"
	<< "34;7;1;000183;000182;Air – Secondary Air Flow;g/s;/100;2"
	<< "34;8;1;000108;;Air – Secondary Air Pressure;kPa;*1;0"
	<< "35;1;1;000117;;VVT – OSV Current Left;mA;*32;0"
	<< "35;2;1;000116;;VVT – OSV Current Right;mA;*32;0"
	<< "35;3;1;000115;;VVT – OSV Duty Left;%;/255*100;1"
	<< "35;4;1;000114;;VVT – OSV Duty Right;%;/255*100;1"
	<< "35;5;1;000113;;Engine – Oil Temperature;°C;-40;0"
	<< "36;2;1;00011E;;VVT – AVLS Lift Mode;;*1;0"
	<< "36;3;1;00011D;;VVT – OCV Current Left Exhaust;mA;*32;0"
	<< "36;4;1;00011C;;VVT – OCV Current Right Exhaust;mA;*32;0"
	<< "36;5;1;00011B;;VVT – OCV Duty Left Exhaust;%;/255*100;1"
	<< "36;6;1;00011A;;VVT – OCV Duty Right Exhaust;%;/255*100;1"
	<< "36;7;1;000119;;VVT – Retard Angle Left Exhaust;deg;-50;0"
	<< "36;8;1;000118;;VVT – Retard Angle Right Exhaust;deg;-50;0"
	<< "43;1;2;000147;;AWD – Yaw Rate Sensor Voltage;V;/51;2"
	<< "43;2;2;000146;;AWD – Solenoid Current;A;/255;2"
	<< "43;3;2;000145;;AT – LU Valve Current;A;/255;2"
	<< "43;4;2;000144;;AT – PL Valve Current;A;/255;2"
	<< "43;5;2;000143;;AT – IC Valve Current;A;/255;2"
	<< "43;6;2;000142;;AT – FB Valve Current;A;/255;2"
	<< "43;7;2;000141;;AT – DC Valve Current;A;/255;2"
	<< "43;8;2;000140;;AT – H&LRC Valve Current;A;/255;2"
	<< "44;1;2;00014F;;AWD – IMU Reference Voltage;V;/51;2"
	<< "44;2;2;00014E;;AWD – Solenoid Pressure;kPa;*10;0"
	<< "44;3;2;00014D;;AT – LU Valve Pressure;kPa;*10;0"
	<< "44;4;2;00014C;;AT – PL Valve Pressure;kPa;*10;0"
	<< "44;5;2;00014B;;AT – IC Valve Pressure;kPa;*10;0"
	<< "44;6;2;00014A;;AT – FB Valve Pressure;kPa;*10;0"
	<< "44;7;2;000149;;AT – DC Valve Pressure;kPa;*10;0"
	<< "44;8;2;000148;;AT – H&LRC Valve Pressure;kPa;*10;0"
	<< "45;1;2;000186;;Fwd/B Solenoid Valve Target Pressure;kPa;*10;0"
	<< "45;2;2;000185;;AWD – FwdB Solenoid Current;A;/255;2"
	<< "45;4;2;00015A;00008D;Steering Angle Sensor;deg;s16*1;0"
	<< "45;5;2;00013F;;AWD – Wheel Speed RL;km/h;*1;0"
	<< "45;6;2;00013E;;AWD – Wheel Speed RR;km/h;*1;0"
	<< "45;7;2;00013D;;AWD – Wheel Speed FL;km/h;*1;0"
	<< "45;8;2;00013C;;AWD – Wheel Speed FR;km/h;*1;0"
	<< "48;1;1;000199;;Ignition – Knock Correction (Hi-Res);deg;-128/4;1"
	<< "48;2;1;0000F9;;Ignition – Learned Timing Correction;deg;/16;1"
	<< "48;3;1;0000F8;;Engine – Misfire Monitor Cyl 6;;*1;0"
	<< "48;4;1;0000EF;;Engine – Misfire Monitor Cyl 5;;*1;0"
	<< "48;5;1;0000D9;;Engine – Misfire Monitor Cyl 4;;*1;0"
	<< "48;6;1;0000D8;;Engine – Misfire Monitor Cyl 3;;*1;0"
	<< "48;7;1;0000CF;;Engine – Misfire Monitor Cyl 2;;*1;0"
	<< "48;8;1;0000CE;;Engine – Misfire Monitor Cyl 1;;*1;0"
	<< "52;8;1;00019A;;Fuel – Tank Pressure;kPa;-128/20;2"
	<< "53;1;1;0001E9;;EGR – Valve Angle;deg;-50;0"
	<< "53;2;1;0001E8;;EGR – Target Valve Angle;deg;-50;0"
	<< "53;3;1;0001E7;;Air – Air Mass per Cylinder;mg/cyl;*10;0"
	<< "53;4;1;0001E6;;Air – Target Air Mass per Cylinder;mg/cyl;*10;0"
	<< "53;5;1;0001E5;;Air – Target Manifold Pressure;kPa;*1;0"
	<< "53;6;1;0001E4;;DSL – Injection Times Count;;*1;0"
	<< "53;7;1;0001E3;0001E2;DSL – Injection Amount Final;mm³;/256;4"
	<< "53;8;1;0001E1;;DSL – Injection Period Main;°CA;/5-15;1"
	<< "54;1;1;0001F7;0001F6;DSL – Pump Target Current;mA;*1;0"
	<< "54;2;1;0001F5;;Electrical – EPS Current;A;*1;0"
	<< "54;3;1;0001F0;;Turbo – Boost Feedback;%;-128;0"
	<< "54;4;1;0001EF;0001EE;Engine – Target Speed;rpm;/4;0"
	<< "54;5;1;0001ED;;Air – Intake Temperature Combined;°C;-40;0"
	<< "54;6;1;0001EC;;DSL – Common Rail Pressure;MPa;*1;0"
	<< "54;7;1;0001EB;;DSL – Common Rail Target Pressure;MPa;*1;0"
	<< "54;8;1;0001EA;;EGR – Duty;%;*1;0"
	<< "55;5;2;0001F4;;AWD – DCCD Mode;;*1;0"
	<< "55;6;2;0001F3;;AWD – DCCD Torque Allocation;;*1;0"
	<< "55;7;2;0001F2;;AWD – Lateral G;m/s²;s8*1.0862;2"
	<< "55;8;2;0001F1;;AWD – Yaw Rate;deg/s;s8*0.19118;0"
	<< "56;1;1;000260;;DSL – Quantity Correction Cylinder 4;ms;-100/100;2"
	<< "56;2;1;00025F;;DSL – Quantity Correction Cylinder 3;ms;-100/100;2"
	<< "56;3;1;00025E;;DSL – Quantity Correction Cylinder 2;ms;-100/100;2"
	<< "56;4;1;00025D;;DSL – Quantity Correction Cylinder 1;ms;-100/100;2"
	<< "56;5;1;000270;;Cooling – Interior Heater Steps;Steps;*1;0"
	<< "56;6;1;000205;000204;DSL – Mileage since Injector Replacement;km;*5;0"
	<< "56;7;1;0001FB;0001FA;DSL – Mileage since Injector Learning;km;*5;0"
	<< "56;8;1;0001F9;0001F8;DSL – Pump Actual Current;mA;*1;0"
	<< "57;6;1;000272;;Electrical – Alternator Mode;;0=High,1=ExHigh,2=Low,3=Mid;0"
	<< "57;7;1;000273;;Electrical – Battery Temperature;°C;-40;0"
	<< "57;8;1;000271;;Electrical – Battery Current;A;-128;0"
	<< "63;1;1;00027C;;DSL – Oil Dilution Ratio;%;*1;0"
	<< "63;2;1;00027B;;DSL – Soot Accumulation;%;*1;0"
	<< "63;3;1;00027A;;DSL – DPF Estimated Temperature;°C;*5-40;0"
	<< "63;4;1;000279;;DSL – Catalyst Estimated Temperature;°C;*5-40;0"
	<< "63;5;1;000278;;DSL – DPF Inlet Exhaust Temperature;°C;*5-40;0"
	<< "63;6;1;000277;;DSL – Catalyst Inlet Exhaust Temperature;°C;*5-40;0"
	<< "63;7;1;000276;;DSL – DPF Differential Pressure;kPa;*1;0"
	<< "63;8;1;000275;;DSL – Ash Accumulation;%;*1;0"
	<< "64;5;2;000297;000296;AT – ATF Deterioration;%;*40/13107;0"
	<< "64;6;2;000295;;AWD – ABS Rear Mean Speed;km/h;*230/255;0"
	<< "64;7;2;000294;;AWD – ABS Front Mean Speed;km/h;*230/255;0"
	<< "64;8;2;000293;;AWD – Front-Rear Ratio;;/128;3"
	<< "65;1;1;00023E;;DSL – Micro-Injection Learning 1-2;ms;-128/200;3"
	<< "65;2;1;00023D;;DSL – Micro-Injection Learning 1-1;ms;-128/200;3"
	<< "65;3;1;00029E;00029D;DSL – DPF Regeneration Count;Times;*1;0"
	<< "65;4;1;00029C;00029B;DSL – DPF Running Distance;km;*1;0"
	<< "65;5;1;00029A;;DSL – Distance to Oil Change;km;*100;0"
	<< "65;6;1;00021F;;DSL – Actual Rail Pressure;MPa;*1;0"
	<< "65;7;1;000299;;DSL – Overspeed Count High;;*1;0"
	<< "65;8;1;000298;;DSL – Overspeed Count Very High;;*1;0"
	<< "66;1;1;000246;;DSL – Micro-Injection Learning 3-2;ms;-128/200;3"
	<< "66;2;1;000245;;DSL – Micro-Injection Learning 3-1;ms;-128/200;3"
	<< "66;3;1;000244;;DSL – Micro-Injection Learning 2-4;ms;-128/200;3"
	<< "66;4;1;000243;;DSL – Micro-Injection Learning 2-3;ms;-128/200;3"
	<< "66;5;1;000242;;DSL – Micro-Injection Learning 2-2;ms;-128/200;3"
	<< "66;6;1;000241;;DSL – Micro-Injection Learning 2-1;ms;-128/200;3"
	<< "66;7;1;000240;;DSL – Micro-Injection Learning 1-4;ms;-128/200;3"
	<< "66;8;1;00023F;;DSL – Micro-Injection Learning 1-3;ms;-128/200;3"
	<< "67;1;1;00024E;;DSL – Micro-Injection Learning 5-2;ms;-128/200;3"
	<< "67;2;1;00024D;;DSL – Micro-Injection Learning 5-1;ms;-128/200;3"
	<< "67;3;1;00024C;;DSL – Micro-Injection Learning 4-4;ms;-128/200;3"
	<< "67;4;1;00024B;;DSL – Micro-Injection Learning 4-3;ms;-128/200;3"
	<< "67;5;1;00024A;;DSL – Micro-Injection Learning 4-2;ms;-128/200;3"
	<< "67;6;1;000249;;DSL – Micro-Injection Learning 4-1;ms;-128/200;3"
	<< "67;7;1;000248;;DSL – Micro-Injection Learning 3-4;ms;-128/200;3"
	<< "67;8;1;000247;;DSL – Micro-Injection Learning 3-3;ms;-128/200;3"
	<< "69;5;1;000258;000257;DSL – Injection Period Final;ms;/1000;3"
	<< "69;6;1;000239;000238;DSL – Injection Pump Differential Learning;mA;-1000;0"
	<< "69;7;1;000250;;DSL – Micro-Injection Learning 5-4;ms;-128/200;3"
	<< "69;8;1;00024F;;DSL – Micro-Injection Learning 5-3;ms;-128/200;3";
